...
const questionBank = [
    ...
    { question: "In developing an information security plan, what should a company do first?", options: ["It should buy state of the art technology","It should buy state of the art technology"], correct: "It should buy state of the art technology" },
